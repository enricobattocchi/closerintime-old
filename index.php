...
<body>
	...
	<section id="chooser" class="transparent">
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-6">
					<label class="sr-only" for="adder">Look up an event or add your own</label>
					<div class="input-group">
						<span class="input-group-addon"><i
							id="adder-pre" class="chooser-event-pre"></i></span> <input
							type="text" class="form-control typeahead"
							placeholder="Look up an event or add your own" id="adder"
							name="adder" value="" /> <span
							class="input-group-btn">
							<button class="btn btn-default hide chooser-link"
								id="adder-link" type="button">
								<i class="fa fa-wikipedia-w"></i>
							</button>
							<button class="btn btn-default chooser-edit"
								id="adder-edit" data-frominput="2" 
								data-toggle="modal" data-target="#suggest"
								type="button">
								<i class="fa fa-pencil"></i>
							</button>
							<button class="btn btn-default hide chooser-cancel" id="adder-cancel"
								type="button">
	...
	<section id="timeline-section">
		<div id="timeline">
			...
			<div class="timeline-part" style="width: 100%;">
				<h6 class="timeline-part-label"></h6>
			</div -->
			<div id="timeline-marker-now" class="timeline-marker">
				<div id="timeline-marker-icon-now" class="timeline-marker-icon"></div>
				<div class="timeline-marker-label">
					<h5 class="date"></h5>
	...
	<footer>
		<section class="right">
			A progressive web app from <a href="https://lopo.it"
				rel="author noopener" target="_blank">Lopo.it</a> - v0.9-beta7 - <a href="#"
	...
	<template style="display: none">
		<div class="timeline-marker timeline-marker-middle"
				style="left: 50%;">
			<div class="timeline-marker-label">
				<h5 class="date"></h5>
				<div class="timeline-marker-description"></div>
		...
		<div class="timeline-part" style="width: 50%;">
			<h6 class="timeline-part-label"></h6>
		</div>
	</template>
</body>
